...
df = pd.read_csv(r"K:\Jilliana Abogado\021125\balanced_risk_dataset.csv")
...
df_filled.to_csv(r"K:\Jilliana Abogado\021125\balanced_risk_dataset_with_empty_values_handled.csv", index=False)
